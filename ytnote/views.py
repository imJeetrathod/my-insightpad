...
def index(request):
    if request.method == 'POST':
        ...
        if api_key:
            ...
            # Render the page with an input form to enter the API key
            return render(request, 'ytnote/index.html', {'api_key_missing': True})
    
    # Render the default page
    return render(request, 'ytnote/index.html')